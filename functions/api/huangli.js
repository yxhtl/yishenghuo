...
16. 【天气】如果提供了天气信息，建议要结合天气：
    ...
    - 热天提醒多喝水、少喝冷饮
    - 但不要生硬地提天气，要自然融入建议
17. 【忌的表述】忌的标题应有一定普适性和传统黄历的凝练感，避免太具体太口语化。
    - 不好的写法："忌喝冰奶茶"（太具体，不喝奶茶的人无感）
    - 好的写法："忌贪凉饮冷"（普适，有黄历味）
    - 保持建议的可操作性，但用更凝练的语言
18. 【每日一言联动】quote 必须与今天的天气、宜忌内容或用户近况有关联，不要用与今天完全无关的通用鸡汤。
    - 天气热→关于"心静"、天气冷→关于"温暖"、雨天→关于"等待与沉淀"
    - 宜了散步→关于"行动的力量"、宜了读书→关于"积累"
    - 用户心情不好→关于"低谷与希望"
19. 【图标风格统一】icon 使用温暖、生活化的 emoji，避免办公/科技类图标（如📋📧📈📎💼💻）。
    推荐：📞🍚💧🚶📖🧘🎵☀️🌙☕🤗🥤
20. 【建议价值】每条建议必须让用户感到"这真的懂我"，而非正确的废话。
    - 不好的写法："多喝水"（谁都知道，没有信息增量）
    - 好的写法："你昨晚熬夜了，今天多喝温水补补水分"（结合近况，有针对性）
    - reason 要给出"为什么是今天"的理由，而不是"为什么这件事好"的大道理`;
